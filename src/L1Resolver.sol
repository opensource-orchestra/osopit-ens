...
contract L1Resolver is IExtendedResolver, Ownable {
    ...
    function resolve(
        ...
        // Encode the parent name and compute its namehash
        bytes memory dnsEncodedParent = NameCoder.encode(parentName);
        bytes32 parentNode = NameCoder.namehash(dnsEncodedParent, 0);
